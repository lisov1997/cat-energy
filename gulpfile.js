        ...
        formats.push(
          {
            ...
            jpegOptions: {
              progressive: true,
              quality: 85, // Качество JPEG (от 0 до 100)
              mozjpeg: true, // Использовать алгоритм MozJPEG для лучшего сжатия
            },
            pngOptions: {
              quality: 85, // Качество PNG (от 0 до 100)
              compressionLevel: 9, // Уровень сжатия (от 0 до 9)
            },
